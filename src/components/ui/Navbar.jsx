...
function Navbar() {
  ...
  return (
    <div>
      <nav className="relative flex item-center justify-between text-white">
        <a href="#">
      ...
      {!showMenu && (
        <div className="lg:hidden">
          <ul className="absolute flex flex-col items-center self-end py-8 mt-5 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md">
            <li>
              <a href="#">Accueil</a>
            </li>
            <li>
