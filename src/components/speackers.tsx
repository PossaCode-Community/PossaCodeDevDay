      ...
      <div className="relative flex flex-col items-center  ">
        ...
        <div className="relative">
          <img
            src={imageSrc}
            alt={name}
            className="z-10 w-56 object-cover grayscale group-hover:grayscale-0 transition-all duration-300 "
          />
        </div>
      </div>
      
      <div className=" flex flex-col gap-2 items-center justify-center md:w-1/2 md:items-start ">
        <span className="text-2xl font-serif font-bold text-white group-hover:text-primaryOrange transition-all duration-300 ">
          {name}
        </span>
